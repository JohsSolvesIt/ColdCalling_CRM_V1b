...
class RealtorDataExtractor {
  ...
  async checkAutoExtraction() {
    try {
      ...
      if (urlParams.get('autoExtract') === 'true') {
      ...
      try {
        ...
        if (dbService) {
          ...
          if (duplicateCheck.isDuplicate) {
            ...
            if (userChoice) {
              // Force full re-extraction even for duplicates when updating
              log.info('🔄 Force re-extracting duplicate agent for fresh data');
