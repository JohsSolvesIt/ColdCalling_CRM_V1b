...
function cleanTestimonialText(text) {
  ...
  let cleaned = text
    ...
    // MORE AGGRESSIVE: Remove ALL rating patterns that start testimonials
    .replace(/^[\d\s\.]+Responsiveness[\d\s\.]*Market expertise[\d\s\.]*Negotiation skills[\d\s\.]*Professionalism.*?communication/i, '')
    .replace(/^Responsiveness[\d\s\.]*Market expertise[\d\s\.]*Negotiation skills[\d\s\.]*Professionalism.*?communication/i, '')
    .replace(/^[\d\s\.]+Responsiveness[\d\s\.]*Market expertise[\d\s\.]*Negotiation skills[\d\s\.]*Professionalism/i, '')
    .replace(/^Responsiveness[\d\s\.]*Market expertise[\d\s\.]*Negotiation skills[\d\s\.]*Professionalism/i, '')
    ...
    // Remove rating category labels more aggressively
    .replace(/^Responsiveness\s*\d+\.\d+\s*Market expertise\s*\d+\.\d+\s*Negotiation skills\s*\d+\.\d+\s*Professionalism.*?communication/gi, '') 
  ...
  // Return cleaned text without truncation for full testimonials
  return cleaned; // Don't truncate - let the full testimonial show
}
...
async function cleanExistingTestimonials() {
  try {
    ...
    // Get ALL testimonials for comprehensive cleaning
